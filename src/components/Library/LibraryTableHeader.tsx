...
interface Props {
    ...
    handlePublicationSorting?: () => void
    publicationSorting: 'asc' | 'desc'
    handleInsertionSorting?: () => void
    insertionSorting: 'asc' | 'desc'
}

const LibraryTableHeader: React.FC<Props> = ({
    elementIndex,
    showSortingButtons,
    handlePublicationSorting,
    publicationSorting,
    handleInsertionSorting,
    insertionSorting,
}) => {
